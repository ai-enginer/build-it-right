  ...
  return (
    <SiteLayout>
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <h1 className="text-3xl font-bold mb-2">Image to PNG</h1>
        <p className="text-muted-foreground mb-6">Convert any image format to PNG</p>
        {!preview ? (
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">Original: {file?.type.split("/")[1]?.toUpperCase()}</p>
            <div className="flex gap-3 justify-center">
              {convertedUrl && <Button asChild><a href={convertedUrl} download={`${file?.name?.split(".")[0] || "image"}.png`}><Download className="h-4 w-4 mr-2" /> Download PNG</a></Button>}
